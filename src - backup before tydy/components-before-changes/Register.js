...
class Register extends React.Component {
  ...
  // ADD CHECK FORM
    onSubmitRegister = () => { //capture values from email/pass to check data
          ...
          <article className="br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center">
              <main className="pa4 black-80">
                  <div className="measure">
                      ...
                      <div className="">
                          <input 
                              onClick={this.onSubmitRegister} // function that gets called to change state to 'home'
                      ...
                      <div className="lh-copy mt3">
                          <p onClick={() => onRouteChange('signin')} className="f6 link dim black db pointer">or Signin?</p>
                      </div>
                  </div>
              </main>
          </article>
