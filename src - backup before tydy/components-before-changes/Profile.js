  ...
  render() {
    ...
    return (
      <div className='profile-modal'>
        <article className='br3 ba b--black-10 mv4 w-100 w-50-m w-25-l mw6 center bg-white'>
          <main className='pa4 black-80 w-80'>
            ...
            <input onChange={this.onFormChange} type='text' name='user-name' className='pa2 ba w-100' value={name}></input>
